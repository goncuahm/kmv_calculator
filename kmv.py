...
D = st.sidebar.number_input("Book Value of Debt (D)", value=1.25e8, step=1.0e7, format="%.2e")
...
shock_frac = st.sidebar.slider("Shock severity (fractional drop in assets) s", 0.0, 0.99, 0.25, 0.01)
